# Quiet Workbench Rail

## Thesis

Keeps the v7 depth idea but turns it into a practical workbench with fewer doors, clearer state, and one pane that owns all site creation.
...
System: Workbench. The palette uses #22577a, #2a9d8f, and #e9c46a as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
