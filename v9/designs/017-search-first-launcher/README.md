...
Treats every start route as searchable: saved site, GitHub repo, PR, blueprint URL, and zip import share one entry point.

## Structural Difference

Template: searchLauncher. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
