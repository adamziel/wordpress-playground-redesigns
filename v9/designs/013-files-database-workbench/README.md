...
For advanced users, the manager is not a settings screen; it is a workbench with file and database evidence.

## Structural Difference

Template: dataWorkbench. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
