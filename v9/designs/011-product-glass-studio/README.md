...
Retains depth from v7 but removes the moody darkness; the glass is functional, not decorative.
...
System: Clear Glass. The palette uses #0b7285, #2b8a3e, and #e67700 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
