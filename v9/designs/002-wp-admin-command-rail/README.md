# WP Admin Command Rail

## Thesis

Borrows WordPress admin density without copying wp-admin chrome, making manager tools feel native while the iframe remains the product.
...
System: Admin Familiar. The palette uses #1e5b7e, #3b7a57, and #d9822b as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
