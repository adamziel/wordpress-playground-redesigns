# Notebook Builder Pages

## Thesis

Organizes experiments as notebook pages: one page for the live site, one for launch, one for manager evidence.

## Structural Difference

Template: notebook. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
