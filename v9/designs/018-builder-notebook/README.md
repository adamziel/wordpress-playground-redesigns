...
Makes Playground feel like a builder notebook: saved sites, experiments, and blueprints are organized as working pages.
...
System: Notebook. The palette uses #7b2cbf, #2d6a4f, and #e85d04 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
