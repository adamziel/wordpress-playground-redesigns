# Tactile Control Room

## Thesis

Uses hardware-console affordances for settings and reset without making the interface feel playful or skeuomorphic.
...
System: Control Room. The palette uses #31572c, #15616d, and #ff7d00 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
