# Presentation Focus Frame

## Thesis

Optimizes for demos: hide the workbench until needed, but keep status and recovery controls in reach.

## Structural Difference

Template: presentation. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
