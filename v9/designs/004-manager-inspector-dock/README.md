# Manager Inspector Dock

## Thesis

Moves the secondary pane to the right, matching developer-tool expectations for files, logs, database, and settings.
...
System: Inspector Dock. The palette uses #234e70, #2f855a, and #c05621 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
