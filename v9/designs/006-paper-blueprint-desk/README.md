# Paper Blueprint Desk

## Thesis

Turns the v7 depth layers into stacked documents: site, pane, library, and reset sheet each has a clear job.
...
System: Paper Desk. The palette uses #7a4e21, #216869, and #d8973c as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
