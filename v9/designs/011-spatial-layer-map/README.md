...
Keeps v7’s spatial idea but makes the layers explicit: live site, Sites pane, Library overlay, and reset sheet.

## Structural Difference

Template: layerMap. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
