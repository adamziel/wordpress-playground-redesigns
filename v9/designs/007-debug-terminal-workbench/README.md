...
Centers the debugging job: logs and reset evidence are visible without burying the running site.

## Structural Difference

Template: terminal. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
