...
Treats Site Manager as an inspector beside the site, matching file, database, logs, and settings tasks.

## Structural Difference

Template: rightInspector. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
