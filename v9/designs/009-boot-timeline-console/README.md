# Boot Timeline Console

## Thesis

Makes Playground state temporal: boot, save, apply, reset, and restore are visible along a timeline.

## Structural Difference

Template: timeline. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
