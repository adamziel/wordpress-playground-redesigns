# Swiss Testing Console

## Thesis

Uses Swiss editorial restraint to make many technical states scannable without turning the frame into a dashboard.
...
System: Swiss Console. The palette uses #cc2936, #084c61, and #f9a03f as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
