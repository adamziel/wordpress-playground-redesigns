...
Shows how start sources, saved sites, and blueprints relate before the user commits to booting anything.

## Structural Difference

Template: routeMap. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is library, so the first decision is intentionally different from neighboring V9 concepts.
