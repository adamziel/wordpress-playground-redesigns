...
Keeps the spatial memory that made v7 promising, but replaces blur-heavy drama with stable docking and clear object identity.
...
System: Spatial Dock. The palette uses #386641, #277da1, and #f8961e as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
