...
Takes the operational density of v7 manager states and makes it easier to scan through aligned rows and stable metrics.
...
System: Ops Matrix. The palette uses #005f73, #2a9d8f, and #ee9b00 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
