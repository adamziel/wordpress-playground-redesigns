# Blueprint Library Stage

## Thesis

When discovery is the job, the blueprint library becomes the stage and the live site becomes the proof panel.

## Structural Difference

Template: libraryStage. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is library, so the first decision is intentionally different from neighboring V9 concepts.
