...
Reduces Playground to the few browser-like affordances people already understand, then moves everything else into one pane.
...
System: Browser Minimal. The palette uses #0f4c81, #2e7d32, and #c56b2c as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
