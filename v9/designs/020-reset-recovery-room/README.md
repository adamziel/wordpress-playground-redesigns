...
Makes the most dangerous flow the clearest design: snapshot first, diff second, reset third, restore always visible.

## Structural Difference

Template: recovery. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is reset, so the first decision is intentionally different from neighboring V9 concepts.
