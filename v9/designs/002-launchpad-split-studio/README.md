# Launchpad Split Studio

## Thesis

Starts with the question “what do you want to boot?” and keeps a live preview beside the launch choices.

## Structural Difference

Template: splitLauncher. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
