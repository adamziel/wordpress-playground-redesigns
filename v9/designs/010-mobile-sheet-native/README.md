...
Designs the mobile experience first: the site, status, and next action are visible before any desktop metaphor appears.

## Structural Difference

Template: mobileNative. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
