# Blueprint Map Drawer

## Thesis

Makes the relationship between sources, saved sites, and blueprint library explicit in a single navigable map.
...
System: Map Drawer. The palette uses #1b6ca8, #2a9d5b, and #e76f51 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
