# Mobile Bottom Sheet Canon

## Thesis

Starts from mobile instead of shrinking desktop: rail becomes bottom tabs and the single pane becomes a real bottom sheet.
...
System: Mobile Canon. The palette uses #0f766e, #2563eb, and #d97706 as functional accents for active state, health/status, and warnings. Border radii stay at 8px or below for controls and panes.
