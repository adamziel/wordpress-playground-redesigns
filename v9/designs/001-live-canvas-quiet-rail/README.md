# Live Canvas Quiet Rail

## Thesis

The iframe is the product; every control becomes a small recovery point around the live canvas.

## Structural Difference

Template: canvas. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
