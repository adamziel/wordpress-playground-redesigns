# Browser Tabs Local Sites

## Thesis

Leans into browser familiarity: saved Playgrounds behave like local tabs, while manager tools live in a side drawer.

## Structural Difference

Template: browserTabs. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is sites, so the first decision is intentionally different from neighboring V9 concepts.
