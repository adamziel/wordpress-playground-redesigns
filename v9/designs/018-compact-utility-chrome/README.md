...
Assumes expert repeat use: dense, stable controls around the iframe with no large drawer stealing context.

## Structural Difference

Template: utility. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
