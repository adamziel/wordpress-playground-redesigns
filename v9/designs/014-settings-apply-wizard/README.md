# Settings Apply Wizard

## Thesis

Turns risky version and storage changes into a clear apply flow with snapshot, diff, confirmation, and recovery.

## Structural Difference

Template: wizard. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is reset, so the first decision is intentionally different from neighboring V9 concepts.
