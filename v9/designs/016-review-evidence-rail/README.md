...
Frames Playground as a review tool: evidence, logs, blueprint, and export actions sit beside the running site.

## Structural Difference

Template: reviewRail. This proposal changes the first-screen composition and workflow emphasis rather than only changing palette. Its default state is manager, so the first decision is intentionally different from neighboring V9 concepts.
